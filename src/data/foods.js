...
export const dietAdvice = {
  '减脂期': {
    ...
    tips: ['每餐吃到七分饱', '多选鸡胸肉、鱼虾、蔬菜', '减少精制碳水和油炸食品', '每天饮水 2L 以上'],
    highlight: '热量缺口是关键，但不要过度节食。',
  },
  '增肌期': {
    desc: '保证充足蛋白质和碳水摄入',
    tips: ['蛋白质每天 1.2-1.6g/kg 体重', '训练后及时补充碳水和蛋白质', '牛肉、鸡蛋、牛奶是好选择', '加餐可选择坚果、酸奶'],
    highlight: '吃够 + 练够，肌肉才会长。',
  },
  '保持期': {
    desc: '均衡营养，维持健康体态',
    tips: ['多样化食材，不挑食', '控制油脂和糖分摄入', '保持规律三餐', '偶尔放纵，不必焦虑'],
    highlight: '均衡才是长久之道，享受健康生活。',
  },
};
